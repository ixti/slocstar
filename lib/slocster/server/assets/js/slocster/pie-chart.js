...
;(function ($) {
  ...
  function add_text(paper, x, y, r, a, text) {
    return paper.text(x + (r - 20) * Math.cos(a * RAD),
                      y + (r - 10) * Math.sin(a * RAD), text);
  }
  ...
  Slocster.initPieChart = function (size) {
    ...
    $el.sector = function (rate, title) {
      ...
      t = add_text(paper, x, y, r, -(a + turn / 2), title).attr({
      ...
      s.activate = function () {
        ...
        t.stop().animate({opacity: 1}, 500, "elastic");
      };
